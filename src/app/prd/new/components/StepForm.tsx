...
export function StepForm({ onSubmit, onBack }: StepFormProps) {
  ...
  const handleSubmit = () => {
    ...
    onSubmit(ideaText.trim(), images.length > 0 ? images : undefined);
  };
  ...
  return (
    <div className="max-w-[720px] mx-auto px-4 sm:px-8">
      ...
      <div className="mb-6">
        <h2 className="text-xl font-bold text-foreground mb-2">프로젝트 아이디어를 알려주세요</h2>
        <p className="text-sm text-muted-foreground">
          자유롭게 프로젝트 아이디어를 설명해주세요. AI가 분석하여 상세 PRD를 작성합니다.
        </p>
      </div>
      ...
      <div className="relative">
        <Textarea
          ...
          placeholder={`예: 반려동물 건강 관리 플랫폼을 만들려고 합니다. 보호자가 건강 기록을 관리하고, 수의사와 실시간 상담할 수 있는 서비스입니다. 주요 기능은 건강 기록 대시보드, 예방접종 일정 관리, 수의사 실시간 채팅, 근처 동물병원 검색 등입니다. 기술 스택은 Next.js + Supabase를 사용할 예정입니다...`}
          rows={8}
