...
import {
  ...
  ArrowRight, Globe, CheckCircle, ArrowLeft
} from 'lucide-react';

const translations = {
  ko: {
    brand: 'PotenKit',
    nav: { it: 'IT 기획', business: '사업 기획', about: '소개' },
    hero: {
      headline: '추상적인 아이디어를',
  ...
  en: {
    brand: 'PotenKit',
    nav: { it: 'IT Planning', business: 'Business Planning', about: 'About' },
    hero: {
...
export default function PotenKitBusinessPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative px-6 pt-32 pb-16 md:pt-40 md:pb-20 bg-gradient-to-b from-[#14A697]/5 to-white">
        <div className="max-w-[1156px] mx-auto text-center max-w-3xl mx-auto">
          ...
          <div className="relative max-w-2xl mx-auto">
            <div className="bg-white rounded-xl shadow-[0px_2px_8px_rgba(0,0,0,0.06)] border border-[#E7E7E7] p-1.5">
              <div className="flex flex-col md:flex-row gap-2">
                ...
                <a
                  href="https://poten-paper.vercel.app"
                  target="_blank"
