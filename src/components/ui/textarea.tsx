      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          className={cn(
            ...
            "flex w-full min-h-[120px] rounded-2xl bg-card px-4 py-3 text-base text-foreground placeholder:text-muted",
            ...
            hasError
              ...
              : "border border-border hover:border-foreground/20 focus:border-primary",
            className
          )}
