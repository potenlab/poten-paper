  ...
  "inline-flex items-center justify-center rounded-full border font-medium whitespace-nowrap shrink-0 [&>svg]:pointer-events-none transition-colors duration-200 overflow-hidden",
  {
    variants: {
      variant: {
        ...
        // Muted - gray
        muted:
          "bg-foreground/5 text-muted border-foreground/10 [a&]:hover:bg-foreground/10",
        // Outline - transparent with border
        outline:
          "bg-transparent text-foreground border-foreground/20 [a&]:hover:bg-foreground/5 [a&]:hover:border-foreground/30",
      },
      size: {
