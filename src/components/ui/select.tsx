    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          // Animations – fade only (no zoom/slide to prevent wobble)
      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            "p-1.5",
            position === "popper" &&
              "max-h-[min(var(--radix-select-content-available-height,400px),400px)] w-full min-w-[var(--radix-select-trigger-width)] overflow-y-auto"
          )}
        >
          {children}
        </SelectPrimitive.Viewport>
